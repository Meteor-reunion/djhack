...
Meteor.methods({
	...
	createParty: function(partyName, partyPassword) {
		...
		if (party && party.password !== partyPassword) {
			// Invalid Login
			throw new Meteor.Error("loginError",
				"The party name and password doesn't match.");
